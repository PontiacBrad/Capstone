<?php
    ...
    include "Controller/DBConnection.php";
        ...
        $Other = $_POST['Other'];
        $sqlinsert = "REPLACE INTO Course_Assessment_Form_Section_1 (CAFS1ID, NewSLOs, Upgrades, Enhancements, Modifications, Other) VALUES ('$CAFS1ID', '$NewSLOs', '$Upgrades', '$Enhancements', '$Modifications', '$Other')";
